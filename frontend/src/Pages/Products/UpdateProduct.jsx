...
const UpdateProduct = ({ product, onUpdateSuccess }) => {
  ...
  return (
    <>
      <button
        className="btn btn-sm btn-ghost text-gray-700 hover:text-red-600 hover:bg-red-50 border-0 gap-1.5 transition-all duration-200"
        ...
        <div className="bg-red-400 p-6 rounded-t-2xl flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-red-100 text-sm">Modify product details</p>
            </div>
          </div>
        </div>
